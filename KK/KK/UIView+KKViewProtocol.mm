...
- (void) userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    kk::ui::View * _view = (__bridge kk::ui::View *) objc_getAssociatedObject(message.webView, "__WKWebViewKKViewProtocol");
    
    if(_view != nullptr) {
        
        kk::Weak<kk::ui::View> * weak = new kk::Weak<kk::ui::View>(_view);
        
        dispatch_async(dispatch_get_main_queue(), ^{
            
            kk::Strong<kk::ui::View> view = weak->operator kk::ui::View *();
...
- (void)webView:(WKWebView *)webView didFailNavigation:(null_unspecified WKNavigation *)navigation withError:(NSError *)error {
    ...
    if(view != nullptr) {
        kk::Strong<kk::Event> e = new kk::Event();
        e.set(new kk::TObject<kk::String,kk::String>({{"errmsg",[[error localizedDescription] UTF8String]}}));
        view->emit("load", e);
    }
}
...
- (void) observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context {
    ...
    if([object isKindOfClass:[WKWebView class]]) {
        if([keyPath isEqualToString:@"estimatedProgress"]) {
            ...
            if(view != nullptr) {
                kk::Strong<kk::Event> e = new kk::Event();
                e.set(new kk::TObject<kk::String,kk::Double>({{"errmsg",[(WKWebView *) object estimatedProgress]}}));
